      ...
      Protected Sub ChangePassword_Click(sender As Object, e As EventArgs)
        If IsValid Then
            ...
            If result.Succeeded Then
                ...
                Dim q = (From p In db.tblProfiles Where p.userID = User.Identity.GetUserId() Select p).FirstOrDefault
                q.userGUID = NewPassword.Text
                db.SubmitChanges()

                Response.Redirect("~/application/profile?action=3")
            Else
                AddErrors(result)
            End If
        End If

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="Default.aspx.vb" Inherits="EventManagerApplication._Default1" %>
                                ...
                                <MasterTableView DataKeyNames="ClientID" DataSourceID="getClientList" AutoGenerateColumns="False" CommandItemDisplay="Top" AllowSorting="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="false" UniqueName="DeleteButton">
                                            <ItemStyle Width="40px" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnDeleteProfile" CommandName="DeleteProfile" runat="server" CommandArgument='<%# Eval("ClientID")%>' CssClass="btn btn-danger btn-xs" ForeColor="White" OnClientClick="javascript:if(!confirm('This action will delete the selected user. Are you sure?')){return false;}">

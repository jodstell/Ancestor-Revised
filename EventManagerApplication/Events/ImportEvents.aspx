<%@ Page Title="Import Events" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="ImportEvents.aspx.vb" Inherits="EventManagerApplication.ImportEvents1" %>
                                                ...
                                                <div class="form-horizontal" role="form">
                                                    ...
                                                    <div class="clear">&nbsp;</div>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <telerik:RadComboBox ID="SupplierIDComboBox" runat="server" Width="250px" MarkFirstMatch="True" Filter="StartsWith " DataSourceID="GetSupplierList" DataValueField="supplierID" DataTextField="supplierName" AllowCustomText="True" AutoPostBack="true" EmptyMessage="Select a Supplier"></telerik:RadComboBox>
                                                ...
                                                <asp:SqlDataSource ID="GetSupplierList" runat="server" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="GetSuppliersByUserIDandClientID" SelectCommandType="StoredProcedure">
                                                    <SelectParameters>
                                                        ...
                                                        <asp:SessionParameter SessionField="CurrentClientID" Name="clientID" Type="Int32"></asp:SessionParameter>
                                                            ...
                                                            <%--<asp:LinqDataSource runat="server" EntityTypeName="" ID="GetSupplierList" ContextTypeName="EventManagerApplication.DataClassesDataContext" OrderBy="supplierName" Select="new (supplierID, supplierName)" TableName="tblSuppliers"></asp:LinqDataSource>--%>
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                             <telerik:RadListBox RenderMode="Lightweight" ID="BrandListBox" runat="server" CheckBoxes="true" ShowCheckAll="true" Width="400px" Height="350px" DataTextField="brandName" DataValueField="brandID" >
                                                        </telerik:RadListBox>

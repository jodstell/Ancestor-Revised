<%@ Page Title="Events" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master"
    CodeBehind="ViewEvents.aspx.vb" Inherits="EventManagerApplication.Events" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <telerik:RadGrid ID="EventDataGrid" runat="server" 
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="eventID" CommandItemDisplay="Top" AllowSorting="true">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="true" DataField="Stage" FilterControlAltText="Filter Stage column"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary btn-xs" ForeColor="White" 
                                                CommandName="ViewEvent" CommandArgument='<%# Eval("eventID")%>'>View  &nbsp;&nbsp;<i class="fa fa-chevron-right"></i></asp:LinkButton>
                        ...
                        <asp:SqlDataSource ID="getEventsByUserID" runat="server" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' 
                            SelectCommand="getEvents_ByUserID" SelectCommandType="StoredProcedure">
                            <SelectParameters>

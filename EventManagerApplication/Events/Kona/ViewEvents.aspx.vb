...
Public Class ViewEvents
                        ...
                        If state = "Yes" Then
                            If Not Page.IsPostBack Then
                                ...
                                Catch ex As Exception
                                    ...
                                    MailHelper.SendMailMessage("no-reply@gigengyn.com", "Error on ViewEvents", "There was a problen with the loading the RadPersistenceManager")
    ...
    Sub PopulateCountLabels()
        'Try
        '    Dim dv0 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    TotalCountLabel.Text = dv0.Count.ToString()

        '    Dim dv1 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv1.RowFilter = "StatusID=1"
        '    ApprovedCountLabel.Text = dv1.Count.ToString()

        '    Dim dv2 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv2.RowFilter = "StatusID=2"
        '    BookedCountLabel.Text = dv2.Count.ToString()

        '    Dim dv3 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv3.RowFilter = "StatusID=3"
        '    CancelledCountLabel.Text = dv3.Count.ToString()

        '    Dim dv4 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv4.RowFilter = "StatusID=4"
        '    ScheduledCountLabel.Text = dv4.Count.ToString()

        '    Dim dv5 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv5.RowFilter = "StatusID=5"
        '    ToplinedCountLabel.Text = dv5.Count.ToString()

        '    'Dim dv6 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    'dv6.RowFilter = "StatusID=6"
        '    'TotalCountLabel.Text = dv6.Count.ToString()

        '    Dim dv7 As System.Data.DataView = DirectCast(getEventsByUserID.[Select](DataSourceSelectArguments.Empty), DataView)
        '    dv7.RowFilter = "StatusID=7"
    ...
    '    RadMap1.DataSource = GetDataTable() ' "getEventsByUserID"

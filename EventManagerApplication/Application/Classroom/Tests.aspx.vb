Public Class Tests
    ...
    Private Sub Tests2_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'bind the grid by first group
            'Dim w = From p In db.Tests Where p.CourseID = Request.QueryString("CourseID") Select p

            'DataList1.DataSource = w
            'DataList1.DataBind()

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="GradeBook.aspx.vb" Inherits="EventManagerApplication.GradeBook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            There are no grades to display at this time.  Please check back again later.
        </div>

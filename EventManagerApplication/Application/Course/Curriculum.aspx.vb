...
Public Class Curriculum1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim s = (From p In db.StudentsInCourses Where p.UserName = User.Identity.Name And p.StudentInCourseID = InCourseID Select p).Count

        If s = 0 Then
            db.AddStudentToCourse(User.Identity.Name, id)
        End If
        ...
        Else
            'the page ID is missing so we need to reload the page and set the page back to 1
            Response.Redirect("/application/course/curriculum?ID=" & Request.QueryString("ID") & "&p=1")
        End If
        ...
        If Not Page.IsPostBack Then
            If type = "7" Then
                'goto the start page if this is a test

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NewEvents.aspx.vb" Inherits="EventManagerApplication.PagesNewEvents" %>
...
<body>
        ...
        <div>
            ...
            <asp:LinqDataSource runat="server" EntityTypeName="" ID="getDataList" ContextTypeName="EventManagerApplication.DataClassesDataContext"
                OrderBy="createdDate desc" TableName="qryGetNewEvents_last24hours">
            </asp:LinqDataSource>
        </div>

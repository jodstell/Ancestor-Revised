...
Public Class ShippingMethodsControl
    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As GridItemEventArgs) Handles ShippingMethodList.ItemCreated
    ...
    Protected Sub RadGrid1_ItemInserted(source As Object, e As GridInsertedEventArgs) Handles ShippingMethodList.ItemInserted
    ...
    Protected Sub RadGrid1_PreRender(sender As Object, e As EventArgs) Handles ShippingMethodList.PreRender
    ...
    Private Sub DisplayMessage(text As String)
        ShippingMethodList.Controls.Add(New LiteralControl(String.Format("<span style='color:red'>{0}</span>", text)))
    End Sub
    ...
    Private Sub BrandGroupList_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles ShippingMethodList.ItemCommand
        Select Case e.CommandName
            ...
            Case "ClearFilters"
                For Each column As GridColumn In ShippingMethodList.MasterTableView.Columns
                    column.CurrentFilterFunction = GridKnownFunction.NoFilter
                    column.CurrentFilterValue = [String].Empty
                Next

                ShippingMethodList.MasterTableView.FilterExpression = [String].Empty
                ShippingMethodList.MasterTableView.Rebind()

            Case "ExportToCSV"
                ConfigureExport()

                ShippingMethodList.MasterTableView.ExportToCSV()
    ...
    Public Sub ConfigureExport()
        ...
        ShippingMethodList.ExportSettings.ExportOnlyData = False
        ShippingMethodList.ExportSettings.IgnorePaging = True
        ShippingMethodList.ExportSettings.OpenInNewWindow = True
        ShippingMethodList.ExportSettings.UseItemStyles = False
        ShippingMethodList.ExportSettings.FileName = "Teams"

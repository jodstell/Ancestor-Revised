<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CategoriesControl.ascx.vb" Inherits="EventManagerApplication.CategoriesControl" %>

<telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server"  ClientEvents-OnRequestStart="requestStart">

<telerik:RadGrid ID="CategoryList" runat="server" DataSourceID="getCategoriesList"
        AllowSorting="True"
        AllowPaging="True"
            ...
            <CommandItemTemplate>
                <div style="padding: 3px 0 3px 5px">
                    <asp:LinkButton ID="btnAddNew" runat="server" CommandName="InitInsert" CssClass="btn btn-success btn-sm" ForeColor="White" 
                        Visible='<%# Not CategoryList.MasterTableView.IsItemInserted %>'> <i class="fa fa-plus"></i> Add New Category</asp:LinkButton>

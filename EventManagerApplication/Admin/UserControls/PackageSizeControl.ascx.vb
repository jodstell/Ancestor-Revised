...
Public Class PackageSizeControl
    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As GridItemEventArgs) Handles PackageSizeList.ItemCreated
    ...
    Protected Sub RadGrid1_ItemInserted(source As Object, e As GridInsertedEventArgs) Handles PackageSizeList.ItemInserted
    ...
    Protected Sub RadGrid1_PreRender(sender As Object, e As EventArgs) Handles PackageSizeList.PreRender
    ...
    Private Sub DisplayMessage(text As String)
        PackageSizeList.Controls.Add(New LiteralControl(String.Format("<span style='color:red'>{0}</span>", text)))
    End Sub
    ...
    Private Sub BrandGroupList_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles PackageSizeList.ItemCommand
        Select Case e.CommandName
            ...
            Case "ClearFilters"
                For Each column As GridColumn In PackageSizeList.MasterTableView.Columns
                    column.CurrentFilterFunction = GridKnownFunction.NoFilter
                    column.CurrentFilterValue = [String].Empty
                Next

                PackageSizeList.MasterTableView.FilterExpression = [String].Empty
                PackageSizeList.MasterTableView.Rebind()

            Case "ExportToCSV"
                ConfigureExport()

                PackageSizeList.MasterTableView.ExportToCSV()
    ...
    Public Sub ConfigureExport()
        ...
        PackageSizeList.ExportSettings.ExportOnlyData = False
        PackageSizeList.ExportSettings.IgnorePaging = True
        PackageSizeList.ExportSettings.OpenInNewWindow = True
        PackageSizeList.ExportSettings.UseItemStyles = False
        PackageSizeList.ExportSettings.FileName = "Teams"

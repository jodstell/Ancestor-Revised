<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="BrandCategoryControl.ascx.vb" Inherits="EventManagerApplication.BrandCategoryControl" %>
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        ...
        <telerik:AjaxSetting AjaxControlID="UploadAttachments1">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="BrandCategoryControlPanel" LoadingPanelID="RadAjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
        ...
        <telerik:AjaxSetting AjaxControlID="UploadAttachments1">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="PhotoPanel" LoadingPanelID="RadAjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>  
</telerik:RadAjaxManagerProxy>

<telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Bootstrap" BackgroundPosition="Center" Transparency="100"></telerik:RadAjaxLoadingPanel>
...
<asp:Panel runat="server" ID="BrandCategoryControlPanel">

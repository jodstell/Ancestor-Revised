<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddNewMarket.aspx.vb" Inherits="EventManagerApplication.AddNewMarket" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="col-sm-12">
                ...
                <asp:LinkButton ID="BtnSave" runat="server" CssClass="btn btn-primary" ValidationGroup="details">Save</asp:LinkButton>

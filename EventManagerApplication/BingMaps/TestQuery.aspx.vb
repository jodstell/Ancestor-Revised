...
Public Class TestQuery
    ...
    Private MyKey As String = "Ar9r5Jz1bSVYhbZJ4p8CYoOLi1NuWoHVYl1NxJftPJz_FkhXUOxosfSgxDqbIpGg"
...
#Region "Query By Area"
    Public Sub ExampleFindByAreaRadius()
        Label1.Text = vbLf & "ExampleFindByAreaRadius"
...
#Region "Helper Methods"
    ...
    Private Sub ProcessEntityElements(ByVal response As XmlDocument)
        ...
        For i As Integer = 0 To entryElements.Count - 1
            ...
            Label3.Text = String.Format("Coordinates of '{0}': {1}, {2}", name, latitude, longitude)
        Next i
    End Sub
#End Region
...
#Region "Query by Property"
    Public Sub ExampleFindByProperty()
        Label4.Text = vbLf & "ExampleFindByProperty"
...
#Region "Query by Bounding Box"
    Public Sub ExampleFindByBoundingBox()
        Label5.Text = vbLf & "ExampleFindByBoundingBox"
        ' Find all previously uploaded MyShops entities located within
...
#Region "Query By ID"
    ...
    Public Sub ExampleQueryByIdAtom()
        Label6.Text = vbLf & "ExampleQueryByIdAtom"
        ...
        Response.Write(String.Format("Found EntityID {0} Postal Code: {1} Lat,Lon:  ({2},{3})", retrievedEntityId, postalCode, latitude, longitude))
    End Sub

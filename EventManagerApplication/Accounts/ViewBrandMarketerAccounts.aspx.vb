...
Public Class ViewBrandMarketerAccounts
    ...
    Private Sub AccountDataGrid_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles AccountDataGrid.ItemCommand
        ...
        Select Case e.CommandName
            ...
            Case "ClearFilters"
                ...
                For Each column As GridColumn In AccountDataGrid.MasterTableView.Columns
                    column.CurrentFilterFunction = GridKnownFunction.NoFilter
                    column.CurrentFilterValue = [String].Empty
                Next

                AccountDataGrid.MasterTableView.FilterExpression = [String].Empty
                AccountDataGrid.MasterTableView.Rebind()

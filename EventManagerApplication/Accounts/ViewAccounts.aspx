<%@ Page Title="Accounts" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="ViewAccounts.aspx.vb" Inherits="EventManagerApplication.ViewAccounts" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <asp:LinqDataSource ID="GetAccounts" runat="server" ContextTypeName="EventManagerApplication.DataClassesDataContext"
                        EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="qryViewAccounts" OrderBy="accountName">
                    </asp:LinqDataSource>

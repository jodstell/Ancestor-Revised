...
Public Class ViewProspectAmbassador
    ...
    Private Sub btnSubmitAmbassador_Click(sender As Object, e As EventArgs) Handles btnSubmitAmbassador.Click
        ...
        Else
            ...
            MailHelper.SendMailMessage("no-reply@gigengyn.com", "There was an error adding a new Brand Ambassador", result.Errors.FirstOrDefault())
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        ...
        Response.Redirect("/ambassadors/PendingList?LoadState=Yes")
    End Sub
    ...
    Private Sub btnSubmitReject_Click(sender As Object, e As EventArgs) Handles btnSubmitReject.Click

        Dim result = (From p In db.tblAmbassadors Where p.ambassadorID = Request.QueryString("UserID") Select p).FirstOrDefault

        Dim NewNote As New tblAmbassadorNote With {.userID = result.userID, .comment = CommentTextBox.Text, .createdBy = Context.User.Identity.GetUserId(), .createdDate = Date.Now()}
    ...
    Private Sub btnCancelReject_Click(sender As Object, e As EventArgs) Handles btnCancelReject.Click
        DetailPanel.Visible = True

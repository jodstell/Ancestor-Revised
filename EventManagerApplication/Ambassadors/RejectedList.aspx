<%@ Page Title="Rejected List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="RejectedList.aspx.vb" Inherits="EventManagerApplication.RejectedList" %>
...
<telerik:RadPersistenceManager ID="RadPersistenceManager1" runat="server">
    <PersistenceSettings>
        <telerik:PersistenceSetting ControlID="RejectedAmbassadorsList" />
    </PersistenceSettings>
...
<div class="container">
     ...
     <asp:Panel ID="Panel1" runat="server">
             ...
             <div class="row">
            <div class="col-xs-12">
                <h2>Brand Ambassadors: Rejected</h2>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home" aria-hidden="true"></i><a href="/">Dashboard</a></li>
                    <li class="active">Rejected Ambassadors</li>
                </ol>

            </div>
        </div>

            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="3" Skin="Bootstrap">
                            <Tabs>
    ...
    <div class="widget stacked">
        <div class="widget-content">
            ...
            <telerik:RadGrid ID="RejectedAmbassadorsList" runat="server" DataSourceID="getRejectedAmbassadors"
                ...
                EnableHeaderContextFilterMenu="true" OnFilterCheckListItemsRequested="RejectedAmbassadorList_FilterCheckListItemsRequested">
            ...
            <asp:LinqDataSource ID="getRejectedAmbassadors" runat="server" ContextTypeName="EventManagerApplication.DataClassesDataContext" EntityTypeName="" 
                TableName="qryViewRejectedAmbassadors"></asp:LinqDataSource>

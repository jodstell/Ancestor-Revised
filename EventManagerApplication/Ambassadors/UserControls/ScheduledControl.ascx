<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ScheduledControl.ascx.vb" Inherits="EventManagerApplication.ScheduledControl" %>
...
<%--<telerik:RadListView ID="SechedulesPaymantList" runat="server" DataSourceID="getScheduledPayments" DataKeyNames="RequirementID" AllowPaging="True" Skin="Bootstrap">
    <LayoutTemplate>
    ...
    <ItemTemplate>
        ...
        <tr>
            ...
            <td><asp:Label Text='<%# Eval("Labor", "{0:c}") %>' runat="server" ID="TotalLabel" /></td>
            <td class="hidden-xs">

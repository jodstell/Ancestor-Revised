...
Public Class GetLicense
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim filetype = (From p In db.tblAmbassadors Where p.userID = Request.QueryString("UserID") Select p.licenseFileType).FirstOrDefault
        Dim filename = (From p In db.tblAmbassadors Where p.userID = Request.QueryString("UserID") Select p.licenseFileName).FirstOrDefault

<%@ Page Title="Pending List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="PendingList.aspx.vb" Inherits="EventManagerApplication.PendingList" %>
...
<telerik:RadPersistenceManager ID="RadPersistenceManager1" runat="server">
    <PersistenceSettings>
        <telerik:PersistenceSetting ControlID="PendingAmbassadorsList" />
        </PersistenceSettings>
      ...
      <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnableAJAX="true">
        ...
        <asp:Panel ID="Panel1" runat="server">
             ...
             <div class="row">
            <div class="col-xs-12">
                <h2>Brand Ambassadors: Prospects</h2>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home" aria-hidden="true"></i><a href="/">Dashboard</a></li>
                    <li class="active">Pending Ambassadors</li>
                </ol>

            </div>
        </div>

            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="1" Skin="Bootstrap">
                            <Tabs>
...
<%--<telerik:RadTab Text="Payments" runat="server" ID="paymentsTab"></telerik:RadTab>--%>
    ...
    <div class="widget stacked">
        <div class="widget-content">
            ...
            <telerik:RadGrid ID="PendingAmbassadorsList" runat="server" DataSourceID="getPendingList"
                ...
                OnFilterCheckListItemsRequested="PendingAmbassadorList_FilterCheckListItemsRequested">

                <ExportSettings IgnorePaging="true" OpenInNewWindow="true" ></ExportSettings>

                <MasterTableView AutoGenerateColumns="False" DataKeyNames="ambassadorID" DataSourceID="getPendingList" CommandItemDisplay="Top" AllowSorting="true" AllowMultiColumnSorting="true">
            ...
            <asp:LinqDataSource ID="getPendingList" runat="server" ContextTypeName="EventManagerApplication.DataClassesDataContext" EntityTypeName=""
                TableName="qryViewPendingAmbassadors" OrderBy="ambassadorID desc">
            </asp:LinqDataSource>

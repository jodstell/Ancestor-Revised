<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="MissingCourses.aspx.vb" Inherits="EventManagerApplication.MissingCourses" %>
...
<%--               <telerik:ReportViewer
            ...
            Deferred="true"
                    width="100%"
            runat="server">
          <ReportSource Identifier="CustomSupplier/MissingCourses.trdp" IdentifierType="UriReportSource">
                </ReportSource>
        </telerik:ReportViewer>

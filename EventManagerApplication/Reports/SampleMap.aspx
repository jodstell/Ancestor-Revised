<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="SampleMap.aspx.vb" Inherits="EventManagerApplication.SampleMap" %>
...
<%--               <telerik:ReportViewer
            ...
            Deferred="true"
                    width="100%"
            runat="server">
          <ReportSource Identifier="SampleMap.trdp" IdentifierType="UriReportSource">
                </ReportSource>
        </telerik:ReportViewer>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="Payroll.aspx.vb" Inherits="EventManagerApplication.BARetcPayroll" %>
...
<%--               <telerik:ReportViewer
            ...
            Deferred="true"
                    width="100%"
            runat="server">
          <ReportSource Identifier="ClientReports/BARetc/PayrollReport.trdp" IdentifierType="UriReportSource">
                </ReportSource>
        </telerik:ReportViewer>

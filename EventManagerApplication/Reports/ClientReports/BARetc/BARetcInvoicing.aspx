<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Dashboard.Master" CodeBehind="BARetcInvoicing.aspx.vb" Inherits="EventManagerApplication.BARetcInvoicing" %>
...
<%--               <telerik:ReportViewer
            ...
            Deferred="true"
                    width="100%"
            runat="server">
          <ReportSource Identifier="ClientReports/BARetc/Invoice.trdp" IdentifierType="UriReportSource">
                </ReportSource>
        </telerik:ReportViewer>
